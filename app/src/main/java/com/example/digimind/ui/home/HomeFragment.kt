...
**/
        storage.collection("actividades")
            .whereEqualTo("email",usuario.currentUser.email)//consulta mail del catalogo usuario // consulta del logingmail
            .get()
            ...
            .addOnFailureListener{
                Toast.makeText(context,"Error: intentar de nuevo", Toast.LENGTH_SHORT).show()
            }
    }
